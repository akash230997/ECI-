...
// Download Bug
//const btnDownload2 = document.querySelectorAll('#btnDownload2');
//console.log(btnDownload2);
function download(url) {
    var a = $("<a style='display:none' id='js-downloder2'>")
        .attr("href", url)
        .attr("download", "test.png")
        .appendTo("body");
...
function init() {
    (renderer = new THREE.WebGLRenderer({ antialias: !0 })).setSize(
        ...
        renderer.setClearColor('#FDFAF6'),
        document.getElementById("canvas").appendChild(renderer.domElement),
        ((scene = new THREE.Scene()).fog = new THREE.FogExp2('rgba(255,96,23,1)', 0.0025)),
